              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                {[
                  ...
                  <div key={field.key}>
                    ...
                    <input type={field.type} placeholder={field.placeholder} value={(form as any)[field.key]} onChange={(e) => setForm({ ...form, [field.key]: e.target.value })}
                ...
                <div>
                  ...
                  <textarea placeholder="Tu mensaje..." value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} rows={5}
                ...
                <button onClick={handleSubmit} disabled={loading} style={{ background: loading ? "#333" : "#ff4500", color: loading ? "#666" : "#000", border: "none", padding: "16px", fontSize: "12px", letterSpacing: "3px", fontWeight: "bold", cursor: loading ? "not-allowed" : "pointer", fontFamily: "monospace" }}>
